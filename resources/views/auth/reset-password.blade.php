                ...
                <div class="pt-0">
                    ...
                    <form method="POST" action="{{route('password.update')}}" class="my-4">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" name="password" type="password" id="password" required="" placeholder="Enter new password">
                        </div>
                        <div class="form-group mb-3">
                            <label for="password-confirmation" class="form-label">Confirm Password</label>
                            <input class="form-control" name="password_confirmation" type="password" id="password-confirmation" required="" placeholder="Confirm new password">
                        </div>
                    ...
                    <div class="text-center text-muted">
                        <p class="mb-0">Change the mind ?<a class='text-primary ms-2 fw-medium' href="{{ route('register') }}">Back to Login</a></p>
                    </div>
                </div>
