@extends('layouts.vertical', ['title' => 'Edit Checkout Page Content'])
        ...
        <div class="col-xl-12">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3">
                    <h5 class="card-title mb-0 fw-semibold">Edit Checkout Page Content</h5>
                </div><!-- end card header -->

                <div class="card-body">
                    <form class="row g-3" action="{{ route('checkout-page-contents.update', $checkoutPageContent->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                id="title" value="{{ old('title', $checkoutPageContent->title) }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="button_proceed" class="form-control @error('button_proceed') is-invalid @enderror"
                                id="button_proceed" value="{{ old('button_proceed', $checkoutPageContent->button_proceed) }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="text_shipping" class="form-control @error('text_shipping') is-invalid @enderror"
                                id="text_shipping" value="{{ old('text_shipping', $checkoutPageContent->text_shipping) }}" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="text_add_address" class="form-control @error('text_add_address') is-invalid @enderror"
                                id="text_add_address" value="{{ old('text_add_address', $checkoutPageContent->text_add_address) }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="text_date_time" class="form-control @error('text_date_time') is-invalid @enderror"
                                id="text_date_time" value="{{ old('text_date_time', $checkoutPageContent->text_date_time) }}" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="text_select_date_time" class="form-control @error('text_select_date_time') is-invalid @enderror"
                                id="text_select_date_time" value="{{ old('text_select_date_time', $checkoutPageContent->text_select_date_time) }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="text_payment" class="form-control @error('text_payment') is-invalid @enderror"
                                id="text_payment" value="{{ old('text_payment', $checkoutPageContent->text_payment) }}" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="text_select_payment_method" class="form-control @error('text_select_payment_method') is-invalid @enderror"
                                id="text_select_payment_method" value="{{ old('text_select_payment_method', $checkoutPageContent->text_select_payment_method) }}" required>
                        </div>
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" name="status"
                                id="status" required>
                                <option value="1" {{ old('status', $checkoutPageContent->status) == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('status', $checkoutPageContent->status) == 0 ? 'selected' : '' }}>Inactive</option>
                            </select>
                        </div>
