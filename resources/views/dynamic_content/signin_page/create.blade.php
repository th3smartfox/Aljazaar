@extends('layouts.vertical', ['title' => 'Create Signin Page Content'])
        ...
        <div class="col-xl-12">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3">
                    <h5 class="card-title mb-0 fw-semibold">Create New Signin Page Content</h5>
                </div><!-- end card header -->

                <div class="card-body">
                    <form class="row g-3" action="{{ route('signin-pages.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                id="title" value="{{ old('title', 'Welcome Back') }}" required>
                            @error('title')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="sub_title"
                                ...
                                value="{{ old('sub_title', 'Login with your email or phone number to continue.') }}"
                                required>
                            @error('sub_title')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="email_or_phone_hint"
                                ...
                                value="{{ old('email_or_phone_hint', 'Enter your email or phone number') }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="password_hint"
                                ...
                                value="{{ old('password_hint', 'Your Password') }}" required>
                            @error('password_hint')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="forgot_password_text"
                                ...
                                id="forgot_password_text" value="{{ old('forgot_password_text', 'Forgot Password?') }}"
                                required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="login_button_text"
                                ...
                                value="{{ old('login_button_text', 'Login') }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="dont_have_account_text"
                                ...
                                value="{{ old('dont_have_account_text', "Don't have an account?") }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="sign_up_text"
                                ...
                                value="{{ old('sign_up_text', 'Sign Up') }}" required>
                            @error('sign_up_text')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
