@extends('layouts.vertical', ['title' => 'Create Personal Info Page'])
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <form class="row g-3" action="{{ route('personal-information-pages.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                id="title" value="{{ old('title', 'Personal Information') }}" required>
                        </div>
