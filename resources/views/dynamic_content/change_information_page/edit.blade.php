@extends('layouts.vertical', ['title' => 'Edit Change Info Page Content'])
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <form class="row g-3" action="{{ route('change-information-pages.update', $changeInformationPage->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                id="title" value="{{ old('title', $changeInformationPage->title) }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" name="status"
                                id="status" required>
                                <option value="1" {{ old('status', $changeInformationPage->status) == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('status', $changeInformationPage->status) == 0 ? 'selected' : '' }}>Inactive</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="label_account" class="form-control @error('label_account') is-invalid @enderror"
                                id="label_account" value="{{ old('label_account', $changeInformationPage->label_account) }}" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="label_personal_information" class="form-control @error('label_personal_information') is-invalid @enderror"
                                id="label_personal_information" value="{{ old('label_personal_information', $changeInformationPage->label_personal_information) }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="label_payment_method" class="form-control @error('label_payment_method') is-invalid @enderror"
                                id="label_payment_method" value="{{ old('label_payment_method', $changeInformationPage->label_payment_method) }}" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="label_card_information" class="form-control @error('label_card_information') is-invalid @enderror"
                                id="label_card_information" value="{{ old('label_card_information', $changeInformationPage->label_card_information) }}" required>
                        </div>
