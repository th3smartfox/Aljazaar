@extends('layouts.vertical', ['title' => 'Create Profile Page Content'])
        ...
        <div class="col-xl-12">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3">
                    <h5 class="card-title mb-0 fw-semibold">Create New Profile Page Content</h5>
                </div><!-- end card header -->

                <div class="card-body">
                    <form class="row g-3" action="{{ route('profile-pages.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="main_heading" class="form-control @error('main_heading') is-invalid @enderror"
                                id="main_heading" value="{{ old('main_heading', 'Create Your Profile') }}" required>
                            @error('main_heading')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="button_text" class="form-control @error('button_text') is-invalid @enderror"
                                id="button_text" value="{{ old('button_text', 'Done') }}" required>
                            @error('button_text')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="sub_heading" class="form-control @error('sub_heading') is-invalid @enderror"
                                id="sub_heading" rows="2">{{ old('sub_heading', 'Enter your personal details to set up your account.') }}</textarea>
                            @error('sub_heading')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name_hint" class="form-control @error('name_hint') is-invalid @enderror"
                                id="name_hint" value="{{ old('name_hint', 'Full Name') }}" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name_placeholder" class="form-control @error('name_placeholder') is-invalid @enderror"
                                id="name_placeholder" value="{{ old('name_placeholder', 'Your Name') }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="email_hint" class="form-control @error('email_hint') is-invalid @enderror"
                                id="email_hint" value="{{ old('email_hint', 'Email Address') }}" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="email_placeholder" class="form-control @error('email_placeholder') is-invalid @enderror"
                                id="email_placeholder" value="{{ old('email_placeholder', 'ama@gmail.com') }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="password_hint" class="form-control @error('password_hint') is-invalid @enderror"
                                id="password_hint" value="{{ old('password_hint', 'Password') }}" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="password_placeholder" class="form-control @error('password_placeholder') is-invalid @enderror"
                                id="password_placeholder" value="{{ old('password_placeholder', '**********') }}" required>
                        </div>
