@extends('layouts.vertical', ['title' => 'Profile Page'])
        ...
        <div class="col-12">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-header d-flex justify-content-between align-items-center bg-white py-3">
                    <h5 class="card-title mb-0 fw-semibold">Profile Page List</h5>
                    @if ($profilePages->count() >= 1)
                    {{-- No create button --}}
                    @elseif ($profilePages->count() == 0)
                    <a href="{{ route('profile-pages.create') }}" class="btn btn-primary" id="createButton">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('profile-pages.edit', $page->id) }}"
                                                class="btn btn-sm btn-primary">Edit</a>
                                            <form action="{{ route('profile-pages.destroy', $page->id) }}" method="POST"
