@extends('layouts.vertical', ['title' => 'Successful Page Content'])
    ...
    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
        ...
        <div class="text-end">
            <ol class="breadcrumb m-0 py-0">
                ...
                <li class="breadcrumb-item active">Successful Page</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-header d-flex justify-content-between align-items-center bg-white py-3">
                    <h5 class="card-title mb-0 fw-semibold">Successful Page Content List</h5>
                    <a href="{{ route('successful-pages.create') }}" class="btn btn-primary" id="createButton">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('successful-pages.edit', $page->id) }}"
                                                class="btn btn-sm btn-primary">Edit</a>
                                            <form action="{{ route('successful-pages.destroy', $page->id) }}" method="POST"
