@extends('layouts.vertical', ['title' => 'Create Home Page Content'])
        ...
        <div class="col-xl-12">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3">
                    <h5 class="card-title mb-0 fw-semibold">Create New Home Page Content</h5>
                </div><!-- end card header -->

                <div class="card-body">
                    <form class="row g-3" action="{{ route('home-page-contents.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="tab_new_order" class="form-control @error('tab_new_order') is-invalid @enderror"
                                id="tab_new_order" value="{{ old('tab_new_order', 'New order') }}" required>
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" name="tab_newest" class="form-control @error('tab_newest') is-invalid @enderror"
                                id="tab_newest" value="{{ old('tab_newest', 'Newest') }}" required>
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" name="tab_most_favorite" class="form-control @error('tab_most_favorite') is-invalid @enderror"
                                id="tab_most_favorite" value="{{ old('tab_most_favorite', 'Most favorite') }}" required>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="title_hot_discounts" class="form-control @error('title_hot_discounts') is-invalid @enderror"
                                id="title_hot_discounts" value="{{ old('title_hot_discounts', 'Hot discounts') }}" required>
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" name="title_top_picks" class="form-control @error('title_top_picks') is-invalid @enderror"
                                id="title_top_picks" value="{{ old('title_top_picks', 'Top picks') }}" required>
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" name="title_for_you" class="form-control @error('title_for_you') is-invalid @enderror"
                                id="title_for_you" value="{{ old('title_for_you', 'For You') }}" required>
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" name="title_order_again" class="form-control @error('title_order_again') is-invalid @enderror"
                                id="title_order_again" value="{{ old('title_order_again', 'Order Again') }}" required>
                        </div>
                        ...
                        <div class="col-12">
                            <div id="carouselsContainer" class="row g-3">
                                <!-- Carousels will be added here dynamically -->
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="hot_discount_main_heading" class="form-control"
                                id="hot_discount_main_heading" value="{{ old('hot_discount_main_heading', 'Hot discounts') }}">
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" name="hot_discount_sub_heading" class="form-control"
                                id="hot_discount_sub_heading" value="{{ old('hot_discount_sub_heading') }}">
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" name="hot_discount_side_text" class="form-control"
                                id="hot_discount_side_text" value="{{ old('hot_discount_side_text', 'See All') }}">
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="top_picks_main_heading" class="form-control"
                                id="top_picks_main_heading" value="{{ old('top_picks_main_heading', 'Top picks') }}">
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" name="top_picks_sub_heading" class="form-control"
                                id="top_picks_sub_heading" value="{{ old('top_picks_sub_heading') }}">
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" name="top_picks_side_text" class="form-control"
                                id="top_picks_side_text" value="{{ old('top_picks_side_text', 'See All') }}">
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="order_again_main_heading" class="form-control"
                                id="order_again_main_heading" value="{{ old('order_again_main_heading', 'Order Again') }}">
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" name="order_again_sub_heading" class="form-control"
                                id="order_again_sub_heading" value="{{ old('order_again_sub_heading') }}">
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" name="order_again_side_text" class="form-control"
                                id="order_again_side_text" value="{{ old('order_again_side_text', 'See All') }}">
                        </div>
