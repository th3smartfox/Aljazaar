@extends('layouts.vertical', ['title' => 'Edit Forgot Password Page Content'])
        ...
        <div class="col-xl-12">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3">
                    <h5 class="card-title mb-0 fw-semibold">Edit Forgot Password Page Content</h5>
                </div><!-- end card header -->

                <div class="card-body">
                    <form class="row g-3" action="{{ route('forgot-password-pages.update', $forgotPasswordPage->id) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                id="title" value="{{ old('title', $forgotPasswordPage->title) }}" required>
                            @error('title')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="sub_title"
                                ...
                                value="{{ old('sub_title', $forgotPasswordPage->sub_title) }}" required>
                            @error('sub_title')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="email_or_phone_label"
                                ...
                                value="{{ old('email_or_phone_label', $forgotPasswordPage->email_or_phone_label) }}"
                                required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="email_or_phone_hint"
                                ...
                                value="{{ old('email_or_phone_hint', $forgotPasswordPage->email_or_phone_hint) }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="continue_button_text"
                                ...
                                value="{{ old('continue_button_text', $forgotPasswordPage->continue_button_text) }}"
                                required>
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" name="status" id="status"
                                required>
                                <option value="1" {{ old('status', $forgotPasswordPage->status) == '1' ? 'selected' : '' }}>
                                    Active</option>
                                <option value="0" {{ old('status', $forgotPasswordPage->status) == '0' ? 'selected' : '' }}>
                                    Inactive</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
