@extends('layouts.vertical', ['title' => 'Edit Card Details Page'])
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <form class="row g-3" action="{{ route('card-details-pages.update', $cardDetailsPage->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                id="title" value="{{ old('title', $cardDetailsPage->title) }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" name="status"
                                id="status" required>
                                <option value="1" {{ old('status', $cardDetailsPage->status) == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('status', $cardDetailsPage->status) == 0 ? 'selected' : '' }}>Inactive</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="text_add_card" class="form-control @error('text_add_card') is-invalid @enderror"
                                id="text_add_card" value="{{ old('text_add_card', $cardDetailsPage->text_add_card) }}" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="text_remember_card" class="form-control @error('text_remember_card') is-invalid @enderror"
                                id="text_remember_card" value="{{ old('text_remember_card', $cardDetailsPage->text_remember_card) }}" required>
                        </div>
                        <div class="col-md-3">
                            ...
                            <input type="text" name="hint_card_holder" class="form-control @error('hint_card_holder') is-invalid @enderror"
                                id="hint_card_holder" value="{{ old('hint_card_holder', $cardDetailsPage->hint_card_holder) }}" required>
                        </div>
                        <div class="col-md-3">
                            ...
                            <input type="text" name="hint_card_number" class="form-control @error('hint_card_number') is-invalid @enderror"
                                id="hint_card_number" value="{{ old('hint_card_number', $cardDetailsPage->hint_card_number) }}" required>
                        </div>
                        <div class="col-md-3">
                            ...
                            <input type="text" name="hint_expiry_date" class="form-control @error('hint_expiry_date') is-invalid @enderror"
                                id="hint_expiry_date" value="{{ old('hint_expiry_date', $cardDetailsPage->hint_expiry_date) }}" required>
                        </div>
                        <div class="col-md-3">
                            ...
                            <input type="text" name="hint_cvc" class="form-control @error('hint_cvc') is-invalid @enderror"
                                id="hint_cvc" value="{{ old('hint_cvc', $cardDetailsPage->hint_cvc) }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="text_total" class="form-control @error('text_total') is-invalid @enderror"
                                id="text_total" value="{{ old('text_total', $cardDetailsPage->text_total) }}" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="button_pay_now" class="form-control @error('button_pay_now') is-invalid @enderror"
                                id="button_pay_now" value="{{ old('button_pay_now', $cardDetailsPage->button_pay_now) }}" required>
                        </div>
