@extends('layouts.vertical', ['title' => 'Select City Page'])
    ...
    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
        ...
        <div class="text-end">
            <ol class="breadcrumb m-0 py-0">
                ...
                <li class="breadcrumb-item active">Select City Page</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-header d-flex justify-content-between align-items-center bg-white py-3">
                    <h5 class="card-title mb-0 fw-semibold">Select City Page List</h5>
                    @php
                        $cityCount = $cityPages->count();
                    @endphp
                    @if ($cityCount >= 1)
                        {{-- No create button --}}
                    @elseif ($cityCount == 0)
                    <a href="{{ route('select-city-pages.create') }}" class="btn btn-primary" id="createButton">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('select-city-pages.edit', $page->id) }}"
                                                class="btn btn-sm btn-primary">Edit</a>
                                            <form action="{{ route('select-city-pages.destroy', $page->id) }}" method="POST"
