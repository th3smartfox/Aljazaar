@extends('layouts.vertical', ['title' => 'Create Wallet Page Content'])
        ...
        <div class="col-xl-12">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3">
                    <h5 class="card-title mb-0 fw-semibold">Create New Wallet Page Content</h5>
                </div><!-- end card header -->

                <div class="card-body">
                    <form class="row g-3" action="{{ route('wallet-pages.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="text_hello" class="form-control @error('text_hello') is-invalid @enderror"
                                id="text_hello" value="{{ old('text_hello', 'Hello') }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="title_main_balance" class="form-control @error('title_main_balance') is-invalid @enderror"
                                id="title_main_balance" value="{{ old('title_main_balance', 'Main balance') }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="label_withdraw" class="form-control @error('label_withdraw') is-invalid @enderror"
                                id="label_withdraw" value="{{ old('label_withdraw', 'Withdraw') }}" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="label_transfer" class="form-control @error('label_transfer') is-invalid @enderror"
                                id="label_transfer" value="{{ old('label_transfer', 'Transfer') }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="title_latest_transactions" class="form-control @error('title_latest_transactions') is-invalid @enderror"
                                id="title_latest_transactions" value="{{ old('title_latest_transactions', 'Latest Transactions') }}" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="button_view_all" class="form-control @error('button_view_all') is-invalid @enderror"
                                id="button_view_all" value="{{ old('button_view_all', 'View All') }}" required>
                        </div>
