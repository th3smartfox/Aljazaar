@extends('layouts.vertical', ['title' => 'Create Account Tier Page Content'])
...
@section('content')
    <div class="container-fluid">
        <div class="card bg-primary-subtle shadow-none position-relative overflow-hidden mb-4"
            ...
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-1">Create Account Tier Page Content</h4>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('account-tier-pages.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('app_bar_title') is-invalid @enderror"
                                id="app_bar_title" name="app_bar_title" value="{{ old('app_bar_title') }}" required>
                            @error('app_bar_title')
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('header_image') is-invalid @enderror"
                                id="header_image" name="header_image" value="{{ old('header_image') }}"
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('subtitle') is-invalid @enderror" id="subtitle" name="subtitle" rows="2">{{ old('subtitle') }}</textarea>
                            @error('subtitle')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('terms_text') is-invalid @enderror" id="terms_text" name="terms_text"
                                rows="3">{{ old('terms_text') }}</textarea>
                            @error('terms_text')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea class="form-control @error('terms_of_service_text') is-invalid @enderror" id="terms_of_service_text"
                                name="terms_of_service_text" rows="3" required>{{ old('terms_of_service_text') }}</textarea>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea class="form-control @error('privacy_policy_text') is-invalid @enderror" id="privacy_policy_text"
                                name="privacy_policy_text" rows="3" required>{{ old('privacy_policy_text') }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('renewal_notice') is-invalid @enderror" id="renewal_notice"
                                name="renewal_notice" rows="2">{{ old('renewal_notice') }}</textarea>
