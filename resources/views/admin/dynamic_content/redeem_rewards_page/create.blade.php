@extends('layouts.vertical', ['title' => 'Create Redeem Rewards Page Content'])
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Create Redeem Rewards Page Content</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('redeem-rewards-pages.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('app_bar_title') is-invalid @enderror"
                                    id="app_bar_title" name="app_bar_title" value="{{ old('app_bar_title', 'Redeem Rewards') }}" required>
                                @error('app_bar_title')
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('empty_title') is-invalid @enderror"
                                        id="empty_title" name="empty_title" value="{{ old('empty_title', 'No Rewards Available') }}" required>
                                    @error('empty_title')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('empty_subtitle') is-invalid @enderror"
                                        id="empty_subtitle" name="empty_subtitle" value="{{ old('empty_subtitle', 'Check back later for exciting rewards!') }}" required>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('copy_button_text') is-invalid @enderror"
                                        id="copy_button_text" name="copy_button_text" value="{{ old('copy_button_text', 'Copy Code') }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('copied_message') is-invalid @enderror"
                                        id="copied_message" name="copied_message" value="{{ old('copied_message', 'Code copied to clipboard!') }}" required>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('min_order_label') is-invalid @enderror"
                                        id="min_order_label" name="min_order_label" value="{{ old('min_order_label', 'Min Order') }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('max_discount_label') is-invalid @enderror"
                                        id="max_discount_label" name="max_discount_label" value="{{ old('max_discount_label', 'Max Discount') }}" required>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('expired_label') is-invalid @enderror"
                                        id="expired_label" name="expired_label" value="{{ old('expired_label', 'Expired') }}" required>
                                    @error('expired_label')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('redeemed_label') is-invalid @enderror"
                                        id="redeemed_label" name="redeemed_label" value="{{ old('redeemed_label', 'Redeemed') }}" required>
